...
public class CustomerService {
    ...
    public CustomerView get(Long id) {
        Customer customer = customerRepository.get(id).orElseThrow(() -> new NotFoundException("customer not found, id=" + id, "GET_CUSTOMER_NOT_FOUND"));
    ...
    public CustomerView create(CreateCustomerRequest request) {
        ...
        if (existingCustomer.isPresent()) {
            throw new ConflictException("customer already exists, email=" + request.email, "CREATE_CUSTOMER_CONFLICT");
        }
    ...
    public void update(Long id, UpdateCustomerRequest request) {
        Customer customer = customerRepository.get(id).orElseThrow(() -> new NotFoundException("customer not found, id=" + id, "UPDATE_CUSTOMER_NOT_FOUND"));
